	...
	<div class="container-fluid">
		<div class="col-md-8 col-md-offset-2 panel panel-warning">
			<div class = "panel-heading">
		     <h4 class="text-left text-muted">Edit Project</h4>
		   </div>
		   <div class = "panel-body">
				<s:form action="updateProject" theme="bootstrap">
					...
					<div class="row">
						<div class="col-md-4">
							<s:submit value="Update" class="btn btn-success btn-block"  onclick="doMath();"/>
						</div>
						<div class="col-md-4">
							<s:reset value="Reset" class="btn btn-warning btn-block"  onclick="doMath();"/>
						</div>
						<div class="col-md-4">
						<s:property value = "viewPath"/>
											<s:if test="#viewPath == 'projectReport'"><a href="projectReport" class="btn btn-info btn-block" type="button">Cancel</a></s:if>
						<s:else><a href="viewProject" class="btn btn-info btn-block" type="button">Cancel</a></s:else>
						</div>
					</div>
				</s:form>
			</div>
